  ...
  OAuth, // utility functions
  {
    ...
    formEncode: function formEncode(parameters) {
      ...
      for (var p = 0; p < list.length; ++p) {
        ...
        if (form != "") form += "&";
        form +=
          OAuth.percentEncode(list[p][0]) + "=" + OAuth.percentEncode(value);
      }
      return form;
    },
    ...
    correctTimestampFromSrc: function correctTimestampFromSrc(parameterName) {
      ...
      var q = src.indexOf("?");
      if (q < 0) return;
      parameters = OAuth.getParameterMap(
        OAuth.decodeForm(src.substring(q + 1))
      );
...
OAuth.setProperties(
  OAuth.SignatureMethod.prototype, // instance members
  {
    ...
    initialize: function initialize(name, accessor) {
      ...
      this.key =
        OAuth.percentEncode(consumerSecret) +
        "&" +
...
OAuth.setProperties(
  OAuth.SignatureMethod, // class members
  {
    sign: function sign(message, accessor) {
      var name = OAuth.getParameterMap(
        message.parameters
    ...
    getBaseString: function getBaseString(message) {
      ...
      return (
        OAuth.percentEncode(message.method.toUpperCase()) +
        "&" +
